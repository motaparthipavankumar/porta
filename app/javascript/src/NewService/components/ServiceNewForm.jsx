...
const ServiceNewForm = (props: Props) => {
  const {isVisible, adminServicesPath} = props
  return (<form className={`formtastic service ${isVisible ? '' : 'is-hidden'}`} id="new_service" action={adminServicesPath} acceptCharset="UTF-8" method="post">
    ...
    <fieldset className="inputs" name="Service">
      ...
      <ol>
        ...
        <li id="service_system_name_input" className="string required">
          ...
          <p className="inline-hints">Only ASCII letters, numbers, dashes and underscores are allowed.</p>{/* TODO: Get this from rails */}
        </li>
